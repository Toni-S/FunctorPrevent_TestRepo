...
/* Dummy variable to prevent warning for "empty translation unit" and
   dummy function to prevent warning for "defined but not used" variable */
   int __dummyVar__TinyChain__ = 0;
   void __dummyFunc__TinyChain__( void )
   { if ( __dummyVar__TinyChain__ )
     { __dummyVar__TinyChain__ = 0; }
   }

/* ### End of file TinyChain.c ### */
